...
public class ComparatorTest {
  ...
  public void test1_FeatureValueHelper() throws Exception {
    ...
    try {
      ...
      assertNotNull(result);
      assertEquals(10, result.size());
      final FeatureValue tooSmall = new IntegerFeatureValue("TooSmall", "TooSmall", 0);
  ...
  public void test2_RelationHelper() throws Exception {
    ...
    try {
      ...
      List<FeatureValue> result = RelationHelper.fulfillsOperation(lst, RelationOperator.EQUAL, fv3);
      assertEquals(1, result.size());
      assertTrue(result.contains(fv3));
      result = RelationHelper.fulfillsOperation(lst, RelationOperator.NOT_EQUAL, fv3);
      assertEquals(9, result.size());
      assertFalse(result.contains(fv3));
      assertTrue(result.contains(fvi1));
      assertTrue(result.contains(fv10));
      result = RelationHelper.fulfillsOperation(lst, RelationOperator.LESS_THAN, fv4);
      assertEquals(3, result.size());
      assertTrue(result.contains(fv3));
      assertFalse(result.contains(fv4));
      assertFalse(result.contains(fv5));
      result = RelationHelper.fulfillsOperation(lst, RelationOperator.LESS_OR_EQUAL, fv4);
      assertEquals(4, result.size());
      assertTrue(result.contains(fv3));
      assertTrue(result.contains(fv4));
      assertFalse(result.contains(fv5));
      result = RelationHelper.fulfillsOperation(lst, RelationOperator.GREATER_THAN, fv8);
      assertEquals(2, result.size());
      assertTrue(result.contains(fv10));
      assertTrue(result.contains(fvf9));
      assertFalse(result.contains(fv8));
      assertFalse(result.contains(fv7));
      result = RelationHelper.fulfillsOperation(lst, RelationOperator.GREATER_OR_EQUAL, fv8);
      assertEquals(3, result.size());
      assertFalse(result.contains(fv7));
      assertTrue(result.contains(fv8));
      assertTrue(result.contains(fvf9));
      ...
      result = RelationHelper.fulfillsOperation(fv3, RelationOperator.EQUAL, lst);
      assertEquals(1, result.size());
      assertTrue(result.contains(fv3));
      result = RelationHelper.fulfillsOperation(fv3, RelationOperator.NOT_EQUAL, lst);
      assertEquals(9, result.size());
      assertFalse(result.contains(fv3));
      assertTrue(result.contains(fvi1));
      assertTrue(result.contains(fv10));
      result = RelationHelper.fulfillsOperation(fv4, RelationOperator.GREATER_THAN, lst);
      assertEquals(3, result.size());
      assertTrue(result.contains(fv3));
      assertFalse(result.contains(fv4));
      assertFalse(result.contains(fv5));
      result = RelationHelper.fulfillsOperation(fv4, RelationOperator.GREATER_OR_EQUAL, lst);
      assertEquals(4, result.size());
      assertTrue(result.contains(fv3));
      assertTrue(result.contains(fv4));
      assertFalse(result.contains(fv5));
      result = RelationHelper.fulfillsOperation(fv8, RelationOperator.LESS_THAN, lst);
      assertEquals(2, result.size());
      assertTrue(result.contains(fv10));
      assertTrue(result.contains(fvf9));
      assertFalse(result.contains(fv8));
      assertFalse(result.contains(fv7));
      result = RelationHelper.fulfillsOperation(fv8, RelationOperator.LESS_OR_EQUAL, lst);
      assertEquals(3, result.size());
      assertFalse(result.contains(fv7));
      assertTrue(result.contains(fv8));
      assertTrue(result.contains(fvf9));
